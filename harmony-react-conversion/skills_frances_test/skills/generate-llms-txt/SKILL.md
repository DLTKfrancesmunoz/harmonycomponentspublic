...
description: "Generate llms.txt and llms-full.txt for converted Harmony components for LLM consumption."
...
0. **Check prerequisites.**
   ...
   - Optional: Harmony package installed (`node_modules/@deltek-sst/harmony-design-system/`) for Astro doc pages as a secondary source for descriptions and usage notes.
...
3. **Enrich from Astro docs (optional).**
   - If `node_modules/@deltek-sst/harmony-design-system/src/pages/components/` exists, read the corresponding doc page for each component (e.g. `buttons.astro` for Button).
