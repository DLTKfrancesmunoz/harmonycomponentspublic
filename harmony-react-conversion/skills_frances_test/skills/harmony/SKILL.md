...
2. Else: **Harmony repo** = workspace root; **Consumer project** = `node_modules/@deltek-sst/harmony-design-system` or the path where components were copied (e.g. `src/harmony`).
