...
description: Verifies composed page layouts against layout-builder constraints and pattern anatomy; file-based only; outputs deviation list only; no fixes.
model: inherit
readonly: true
---
