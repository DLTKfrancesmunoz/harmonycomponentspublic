...
**Option A — Harmony npm package (if installed):** Read `{harmonyRoot}/docs/RULES.md` from the installed Harmony package (e.g. `node_modules/@deltek/harmony-components/docs/RULES.md` or `node_modules/@deltek/harmony-design-system/docs/RULES.md`).
